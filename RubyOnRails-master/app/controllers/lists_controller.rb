class ListsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @list.update(list_params)
        format.html { redirect_to new_list_path, notice: 'List was successfully updated.' }
  ...
  def destroy
    @list.destroy
    respond_to do |format|
      format.html { redirect_to new_list_path, notice: 'List was successfully destroyed.' }
